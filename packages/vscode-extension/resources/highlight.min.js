...
;hljs.registerLanguage("css",e)})();/*! `handlebars` grammar compiled for Highlight.js 11.8.0 */
...
;hljs.registerLanguage("markdown",e)})();/*! `node-repl` grammar compiled for Highlight.js 11.8.0 */
...
begin:/^\.\.\.(?=[ ]|$)/}]}]})})();hljs.registerLanguage("node-repl",a)})();/*! `python` grammar compiled for Highlight.js 11.8.0 */
