...
public class JsonSchemaParserTest {
    ...
    public static Stream<Arguments> generateSource() throws Exception {
    ...
    public void generateTest(String description, String schemaFileName, Integer expectedSize, List<String> expectedNames) throws IOException {
        ...
        var customTypes = jsonSchemaParser.parse("TestResponse", specification.getPackageName(), returnType).stream().map(CustomType::getName).toList();
