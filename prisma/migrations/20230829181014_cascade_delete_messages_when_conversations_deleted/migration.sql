...
INSERT INTO "new_conversation_message" ("content", "conversation_id", "createdAt", "id", "name", "role", "type", "user_id") SELECT "content", "conversation_id", "createdAt", "id", "name", "role", "type", "user_id" FROM "conversation_message";
